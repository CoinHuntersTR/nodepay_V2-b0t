...
def run_in_tmux(session_name, script_path, np_token, proxy_file):
  subprocess.run(['tmux', 'new-session', '-d', '-s', session_name, 'python3', script_path, np_token, proxy_file])
...
if __name__ == '__main__':
  ...
  if "TMUX" not in os.environ:
      ...
      run_in_tmux('Nodepay', script_path, np_token, proxy_file)
  else:
      try:
